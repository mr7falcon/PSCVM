...
//Экспортируемые функции для запуска исполнения байт-кода
//Аргументы
//program - массив байт байт-кода
//arg0-arg3 - аргументы программы в виде массива байт
//res - указатель на символьный буфер для возврата строки
//Возвращаемое значение - элемент типа double, string или 
//отсутствует в зависимости от выбранной процедуры запуска
extern "C"
{
